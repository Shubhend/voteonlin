...
.loader__inner {
  ...
  box-shadow: 
    ...
    -35px 0px 0 0 #ffffff;
  background: #ffff00;
  animation: rotates var(--speed) linear infinite;
}
...
<body style="background:#F0F8FF;">
    <?php
    	...
    	if($_GET['id']){
	      $im="imgr/".$easydb->fetchrow("SELECT * FROM viral Where id='$_GET[id]' ",'image');
		   
	}else{
	    $im='https://cdn.iconscout.com/icon/premium/png-256-thumb/raksha-bandhan-854466.png';
...
<img src="<?php echo $im; ?>" height="40px" width="40px" style="border-radius: 100%;"><br><br>
<img src="https://2.bp.blogspot.com/-jGtTRYirjYY/W1hE57u1pmI/AAAAAAAACxY/Cgk7cIKOtsUNpWO_TPdOXXDzxOt_Jv1sQCLcBGAs/s1600/a.png" height="35px" width="35px"><br><br>
<img src="<?php echo $im; ?>" height="40px" width="40px" style="border-radius: 100%;"><br><br>
...
<p style="text-align: center;"><strong><span style="font-size: 14pt; font-family: tahoma, arial, helvetica, sans-serif;"><span style="color: #ff0000;">⍟☆⍣ Happy Raksha Bandhan ⍣☆⍟</span></span></strong></p>
 ...
 <srong><a href="rakshanew.php">Create Your Wish on Rakshabandhan</a></strong>
 <br/>
 <srong><a href="15aug.php">Create Your Wish on 15 August</a></strong>
...
<div class="container">
    ...
    <div class="loader">
 <img class="Image1" src="<?php echo $im; ?>" />
...
<figure>
	...
	<?php 
	if($_GET['id']){
	      $n=$easydb->fetchrow("SELECT * FROM viral Where id='$_GET[id]' ",'name');
		   echo $n;
	}else
	echo $_GET['name'];
	?>
	...
	<h1 style="text-transform: uppercase;">	<?php 	if($_GET['id']){
	      $n=$easydb->fetchrow("SELECT * FROM viral Where id='$_GET[id]' ",'name');
		   echo $n;
	}else
	echo $_GET['name'];
...
<h3>Wishing You</h3>
<h2> <img src="images/r4.gif" class="img-responsive" alt="NEW YEAR" width="100%">
</h2>
...
<h3> <img src="images/r3.gif" class="img-responsive" alt="Happy Rakha Bandhan" width="100%">
</h3>
...
<img src="images/r1.gif" class="img-responsive" alt="Happy Rakha Bandhan" width="100%">
...
</center></center></div></div></div></strong></div></div></div></div></center></body></html>