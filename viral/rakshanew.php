...
function onSuccess(googleUser) {
    ...
    processData: false,
	 ...
	 if(resultData=="ok"){
             ...
             document.getElementById("na").value=resp.name ;
    ...
    <div class="main-greeting">
        <center>
            <form action="upload.php" method="post" enctype="multipart/form-data">
                   ...
                   <input id="na" type="text" name="name" style="display: block;
    width: 100%;
    height: 32px;
    border-radius: 17px;"  placeholder="Your Name??" />
 
<h2>OR</h2>
<h3>Upload Image For Awesome Wish</h3>
...
</div></div></div></strong></div></div></div></div></center>
