...
$userid=$easydb->fetchrow($sql,'memberID');
		...
		$sqlim="SELECT * FROM voteduser Where p_id='$pid' and user_id='$userid'";
		...
		if($rm>0){
			...
			$loc=loc();
			$sqlin="INSERT INTO  voteduser VALUES(NULL,'$userid','$pid','$loc','$longi','$lati','$date','$st','$refr','$ip_address')";
           ...
           echo $rt;
			...
			$sqmm="SELECT * FROM votingrecords Where id='$pid' ";
