...
$date=date("jS F Y ");
$sqlch="SELECT * FROM multivote Where id='$_GET[pid]' and date='$date'";
...
if($coi==0){
   ...
   // $rcc=$easydb->fetchrow($sqlch,count);
	...
	$sqll="SELECT * FROM multivote where id='$_GET[pid]'";
...
<?php echo
implode(' ',array_slice(explode(' ',$row['title']),0,15))."\n"; ?>
...
<meta name="url" content="https://theonlinevoting.com/multivoting.php?pid=<?php echo $_GET['pid']; ?>">
<meta property="og:title" content="<?php echo implode(' ',array_slice(explode(' ',$row['title']),0,8))."\n"; ?>"/>
<meta property="og:type" content="website"/>
<meta property="og:url" content="https://theonlinevoting.com/multivoting.php?pid=<?php echo $_GET['pid']; ?>"/>
<meta property="og:site_name" content="theonlinevoting.com"/>
<meta property="og:description" content="<?php echo substr($row['title'],0,14)."\n"; ?>"/>
<meta property="og:image:type" content="image/jpeg" />
<meta property="og:image:width" content="400" />
<meta property="og:image:height" content="300" />
<meta property="og:image" content="https://theonlinevoting.com/multithumbnail/<?php echo $row['thumbnail']; ?>" />

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="<?php echo implode(' ',array_slice(explode(' ',$row['title']),0,8))."\n"; ?>">
<meta name="twitter:description" content="<?php echo
implode(' ',array_slice(explode(' ',strip_tags($row['des'])),0,14))."\n"; ?>
">
<meta name="twitter:image" content="https://theonlinevoting.com/multithumbnail/<?php echo $row['thumbnail']; ?>">
...
<script type="application/ld+json">
  ...
  "@context": "https://schema.org",
  "@type": "Organization",
  "url": "https://theonlinevoting.com/multivoting.php?pid=<?php echo $_GET['pid']; ?>",
  "logo": "https://theonlinevoting.com/multithumbnail/<?php echo $th ?>"
}
...
foreach($rl as $row) {
  	...
  	<div class="columnsContainer">
	  	...
	  	<div class="leftColumn">
	  		...
	  		<img id="thumbimg" src="multithumbnail/<?php echo $row['thumbnail']; ?>" alt="<?php echo $row['title']; ?>" />
					  <?php //include('ads.php'); ?>
        ...
        <br/>
        <hr/>
        <center><h3>Select Your Vote</h3></center>
        
        <div style="display:flex;width:100%;flex-wrap:wrap;background: lightgray;">
       <?php
    ...
    foreach($rft as $r){
        ...
        ?>
            ...
            <div class="hover" onclick="givevote('<?php echo $r['id']; ?>','<?php echo $id; ?>');" style="width:100px;height:100px;cursor:pointer;margin:5px;background: whitesmoke;"><img style="width:100%;height:100%;" src="multivote/<?php echo $r['image']; ?>" style=""></div>
...
function givevote(id,st){
    
//$("#voted").text("Please Wait");

$.ajax({
      type: "POST",
      url: "phpfiles/multivote.php",
      data: {id: id,st:st},
      success: function(resultData) { 
