...
<script type="text/javascript">
 ...
 $(document).ready(function(){
     $('#m6').html("<span class='curr_mnu'>User Rated Polls</span>");   
	...
	$("#paging_button li").click(function(){
		...
		$("#content").load("user-rate.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("user-rate.php?page=1", hideLoader);
...
$count=mysql_query("select count(*) from user_survey");
