...
<script type="text/javascript">
 ...
 $(document).ready(function(){
     $('#m5').html("<span class='curr_mnu'>Currently Displaying Polls</span>");   
	...
	$("#paging_button li").click(function(){
		...
		$("#content").load("current-data.php?page=" + this.id, hideLoader);
	...
	showLoader();
	$("#content").load("current-data.php?page=1", hideLoader);
...
$count=mysql_query("select count(*) from survey WHERE status='Yes'");
...
?>
		<h1>Currently Displaying Polls</h1>
