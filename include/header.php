  ...
  $("a[href$='https://hosting.india.to']").remove();
   $("a[href$='https://hosting.india.to/linux-reseller-hosting.html']").remove();
            	...
            	<div class="clearfix">
                	...
                	<div class="pull-left logo-box">
                   	...
                   	<div class="nav-outer clearfix">
						...
						<div class="outer-box">
							<!--Nav Toggler-->
							<div class="nav-toggler"><div class="nav-btn"><i class="material-icons" style="font-size:48px;color:white">menu</i></div></div>
						</div>
